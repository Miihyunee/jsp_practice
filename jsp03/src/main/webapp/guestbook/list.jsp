...
<body>
	...
	<form name="form1" method="post">
		...
		</select> <input type="text" name="search" value="${search}"> <input
			type="button" value="조회" onclick="gb_search()">
	</form>
	${count}개의 글이 있습니다. &nbsp;
	...
	<c:forEach var="dto" items="${list}">
		<form action="/jsp03/gb_servlet/passwd_check.do" method="post">
			...
			<table border="1" style="width: 600px">
				<tr>
					<td
						style="text-align: center; background-color: lightpink; width: 20%">이름</td>
					<td style="text-align: center; width: 30%">${dto.name}</td>
					<td
						style="text-align: center; background-color: lightpink; width: 20%">날짜</td>
				...
				<%-- 		<input type="button" onclick="checkPwd(${dto.passwd})"
						value="수정/삭제">  --%> <input type="submit" value="수정/삭제">
					</td>
				</tr>
			</table>
		</form>
